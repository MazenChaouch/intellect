    ...
    return (
        <>
            ...
            <Container className="my-5">
                ...
                <p className="text-center">INTELLECT ACADEMY MT est un Institut de Formation Professionnelle et continue à Menzel temime agrée par l'état propose des formations 100% pratiques assurées par des professionnels et des experts dans divers domaines.</p>
                ...
                <Link to="/formations"><Button className="mt-4">Voir plus</Button></Link>
