...
const Dashboard = () => {
  ...
  const getCandidatByCin = async () => {
    const q = query(
      collection(fireStore, "candidats"),
      where("cin" == "cinid"),
    );
    const fetch = onSnapshot(q, (querySnapshot) => {
      querySnapshot.forEach((doc) => {
    ...
    <>
      ...
      <Container className="p-2">
        ...
        <Row className="my-4">
            ...
            <Card border="primary">
              ...
              <Card.Body>
                <Card.Title className="display-5">
                  Nous avons {candidats.length} candidat
          ...
          <Col sm={6}>
            <Card border="danger">
              ...
              <Card.Body>
                <Card.Title className="display-5">
                  Nous avons {formations.length} formation
        ...
        <h2 className="mb-3 pt-5">
          <FaUsers size={25} className="mb-1" /> Nos candidats
        </h2>
            ...
            {candidats.map((candidat, index) => {
              return (
                <tr key={index} className="text-center">
                  ...
                  <td>
                    <Button variant="info" onClick={() => handleShow(candidat)}>
                      <FaEdit size={20} className="mb-1" />
                    </Button>
                  </td>
                  <td>
                    <Button
                    ...
                    >
                      <FaTrash size={20} className="mb-1" />
                    </Button>
                  </td>
                </tr>
              );
        ...
        <h2 className="mb-3  pt-5">
          <GiBookmarklet size={25} className="mb-1" /> Nos formations
        </h2>
                ...
                <tr key={index}>
                  ...
                  <td>
                    <Button
                      variant="danger"
                      onClick={() => {
                        deleteDoc(doc(fireStore, "formations", formation.id));
                      }}
                    >
                      <FaTrash size={20} className="mb-1" />
                    </Button>
        ...
        <h2 className=" pt-5">
          <BsFillBookmarkPlusFill size={25} className="mb-1" /> Ajouter une
          formation
        </h2>

        <form
          className="row g-3 mt-2 rounded"
          onSubmit={addFormation}
          method="post"
        >
          ...
          <div className="col-md-6">
            ...
            <input
              type="text"
              value={formateur}
              onChange={(e) => setFormateur(e.currentTarget.value)}
              className="form-control"
              placeholder="Entrer le nom du formateur"
              required
            />
          </div>
          <div className="col-md-6">
          ...
          <div className="col-md-6">
            ...
            <input
              ...
              className="form-control"
              placeholder="Entrer la duree de la formation"
              required
            />
          </div>
      ...
      <Modal show={show} onHide={handleClose} size="xl">
        ...
        <Modal.Body>
          <form
            className="row g-3 mt-5 p-4 text-white rounded"
            onSubmit={submitRegistration}
            method="post"
            style={{
              background:
                "radial-gradient(circle, rgba(25,103,225,1) 0%, rgba(17,14,102,1) 100%)",
            }}
          >
            ...
            <div className="col-md-3">
              ...
              <select
                ...
                value={civilite}
                onChange={(e) => setCivilite(e.currentTarget.value)}
                required
              >
                <option selected disabled hidden>
                  -- Choisir votre civilite --
                </option>
            ...
            <div className="col-md-3">
              ...
              >
                <option selected disabled hidden>
                  -- Choisir votre situation actuelle --
                </option>
            ...
            <div className="col-md-3">
              <label className="form-label fw-bold size-lg">
                Niveau scolaire
              </label>
              <input
                type="text"
                value={niveau}
                onChange={(e) => setNiveau(e.currentTarget.value)}
                className="form-control"
            ...
            <div className="col-md-6">
              ...
              <input
                type="text"
                value={nationalite}
                onChange={(e) => setNationalite(e.currentTarget.value)}
                className="form-control"
            ...
            <div className="col-md-6">
              ...
              <input
                ...
                className="form-control"
                placeholder="Entrer votre compte facebook"
                required
              />
            </div>
            <div className="col-md-6">
            ...
            <div className="col-md-6">
              ...
              <input
                ...
                onChange={(e) => setDateDeNaissance(e.currentTarget.value)}
                required
              />
            </div>
            <div className="col-md-6">
              ...
              <input
                ...
                onChange={(e) => setLieuDeNaissance(e.currentTarget.value)}
                className="form-control"
            ...
            <div className="col-md-3">
              ...
              <select
                id="inputState"
                value={formation}
                onChange={(e) => setFormation(e.currentTarget.value)}
                className="form-select"
              >
                <option selected disabled hidden>
                ...
                {formations.map((formation, index) => {
                  return (
                    <option tabIndex={index} value={formation.name}>
                      {formation.name}
                    </option>
                  );
                })}
