        ...
        <>
            ...
            <Container className="py-5">
                <Row>
                    ...
                    <Col sm={6}>
                        <h3 className="fw-normal font-monospace mt-3">{formation.description && parse(formation.description)}</h3>
                    </Col>
                    ...
                    <Col sm={6} className="mt-4">
                        <Table striped bordered hover size="md">
                            <tbody>
                                <tr>
                                    <td><FaChalkboardTeacher /> Formateur</td>
                                    <td>{formation.formateur}</td>
                                </tr>
                                <tr>
                                    <td><FaRegClock /> Durée</td>
                                    <td>{formation.duration}H</td>
                                </tr>
                                <tr>
                                    <td><RiMoneyDollarBoxLine /> Prix</td>
                ...
                <Link to={'/registration'}><Button variant="outline-primary" size="lg" className="fw-bold"><FaPlus size={15} className="mb-1" /> S'inscrire maintenant</Button></Link>
